...
public class GameThread extends JPanel implements Runnable{
    ...
    private GameScreen context; // tham chiếu đến GameScreen
    
    private Thread thread; // thread là luồng chính
    
    private Graphics ThisGraphics; // ảnh 2d để vẽ lên GameThread
    
    public static int FPS = 70; // tốc độ chuyển ảnh
    
    private BufferedImage buffImage; // đc sử dụng để vẽ trò chơi trc khi vẽ lên GameThread
